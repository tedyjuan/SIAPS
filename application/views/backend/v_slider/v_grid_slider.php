								...
								foreach ($grid as $row) : ?>
 								<tr>
 									...
 									<td>
 										<div class="d-flex align-items-center">
 											<div class="h-30 w-30 d-flex-center b-r-50 overflow-hidden text-bg-warning me-2 simple-table-avatar">
 												<img alt="" class="img-fluid" src="<?= base_url('uploads/slider/') . $row->szNameFile ?>">
 											</div>
 										</div>
 									...
 									<td class="text-center">
 										<button type="button" class="btn btn-light-success icon-btn b-r-4" onclick="loadform('admin/cms/C_slider/edit/<?= $row->uuid; ?>')">

 							...
 							<?php $no = 1;
								foreach ($grid as $row) : ?>
 								<tr>
 									<td><?= $row->szCode; ?></td>
 									<td><?= $row->szName; ?></td>
 									<td><?= $row->sing_jurusan . " - " . $row->nm_jurusan; ?></td>
 									<td><?= $row->sing_ting_kls . " - " . $row->nm_kls; ?></td>
 									<td>
 									...
 									<td class="text-center" style="width: 100px;">
 										<button type="button" class="btn btn-light-success icon-btn b-r-4" onclick="loadform('admin/master/C_kelas/edit/<?= $row->uuid; ?>')">

 			...
 			<div class="card-body p-0">
 				<div class="app-datatable-default overflow-auto">
 					...
 					<table class="display app-data-table default-data-table" id="mytable">
 						<thead>
 							<tr>
 								<th style="width: 15px;">Kode kategori</th>
 								<th>Nama kategori</th>
 								<th>Keterangan</th>
 								<th>Status</th>
								...
								foreach ($grid as $row) : ?>
 								<tr>
 									...
 									<td class="text-center">
										<button type="button" class="btn btn-light-success icon-btn b-r-4" onclick="loadform('admin/master/C_kategori/edit/<?= $row->uuid; ?>')">

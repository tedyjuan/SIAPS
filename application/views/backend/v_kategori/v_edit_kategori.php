						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $grid->szName; ?>" data-parsley-required="true" data-parsley-errors-container=".err_tingkatan">
									<span class="text-danger err_tingkatan"></span>
								</div>
								<div class="mb-3">
									<label class="form-label " for="keterangan">Keterangan</label>
									<textarea class="form-control" name="keterangan" id="keterangan" placeholder="Input keterangan" data-parsley-required="true" data-parsley-errors-container=".err_ket"><?= $grid->szDescription; ?></textarea>
		...
		if (form.parsley().isValid()) {
			$.ajax({
				...
				success: function(data) {
					...
					loadform('admin/master/C_kategori');
				}
			});
		}

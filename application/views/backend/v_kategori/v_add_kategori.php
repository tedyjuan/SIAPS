				...
				<form name="forms_add" id="forms_add" method="POST" data-parsley-validate="">
					...
					<div class="app-form">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Input nama kategori" data-parsley-required="true" data-parsley-errors-container=".err_tingkatan">
							<span class="text-danger err_tingkatan"></span>
						</div>
						<div class="mb-3">
							<label class="form-label " for="keterangan">Keterangan</label>
							<textarea class="form-control"  name="keterangan" id="keterangan" placeholder="Input keterangan" data-parsley-required="true" data-parsley-errors-container=".err_ket"></textarea>

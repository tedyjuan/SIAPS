					...
					<div class="app-form">
						<div class="row">
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" value="<?= $grid->szName; ?>" id="nama_kegiatan" name="nama_kegiatan" placeholder="Input nama kegiatan" data-parsley-required="true" data-parsley-errors-container=".err_name">
									<span class="text-danger err_name"></span>
								</div>
								<div class="mb-3">
									<label class="form-label " for="desc_text">Deskripsi</label>
									<textarea class="form-control" name="desc_text" id="desc_text" ><?= $grid->szLongTxt; ?></textarea>
								</div>
							</div>
							<div class="col-6">
								<div class="card">
						...
						<div class="mb-3">
							<div class="col-sm-12 col-lg-12 col-12">
								...
								<div class="imagebox">
									<a style="width: 200px; height: 200px; object-fit: cover;" target="_blank" class="glightbox" href="<?= base_url('uploads/gallery/' . $grid->szNameFile) ?>">
										<img alt="image" class="img-fluid" src="<?= base_url('uploads/gallery/' . $grid->szNameFile) ?>">
									</a>

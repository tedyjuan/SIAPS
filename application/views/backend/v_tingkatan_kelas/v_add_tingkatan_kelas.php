				...
				<form name="forms_add" id="forms_add" method="POST" data-parsley-validate="">
					...
					<div class="app-form">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="singkatan" name="singkatan" placeholder="Input Singkatan Contoh X, XI, XII" data-parsley-required="true" data-parsley-errors-container=".err_name">
							<span class="text-danger err_name"></span>
						</div>
						<div class="mb-3">
							<label class="form-label " for="nama_tingakatan">Nama Tingakatan</label>
							<input type="text" class="form-control" id="nama_tingakatan" name="nama_tingakatan" placeholder="Input nama tingakatan" data-parsley-required="true" data-parsley-errors-container=".err_tingkatan">
		...
		if (form.parsley().isValid()) {
			$.ajax({
				...
				success: function(data) {
					...
					loadform('admin/master/C_tingkatan_kelas');
				}
			});
		}

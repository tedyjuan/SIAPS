				...
				<form name="forms_add" id="forms_add" method="POST" data-parsley-validate="">
					...
					<div class="app-form">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="singkatan" name="singkatan" placeholder="Input Singkatan Contoh IPA, IPS, TKJ" data-parsley-required="true" data-parsley-errors-container=".err_name">
		...
		if (form.parsley().isValid()) {
			$.ajax({
				...
				success: function(data) {
					...
					loadform('admin/master/C_jurusan');
				}
			});
		}

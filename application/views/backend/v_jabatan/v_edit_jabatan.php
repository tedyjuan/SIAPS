					...
					<div class="app-form">
						<div class="row">
							...
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="nm_jabatan" name="nm_jabatan" value="<?= $grid->szName; ?>" data-parsley-required="true" data-parsley-errors-container=".err_name">
						...
						<div class="row">
							<div class="col-3">
								<div class="mb-3">
									...
									<select class="form-control" name="lvl_jabatan" id="lvl_jabatan" data-parsley-required="true" data-parsley-errors-container=".err_lvl_jabatan">
										...
										<?php for ($i = 1; $i <= 10; $i++) { ?>
											<option value="<?= $i; ?>" <?= $grid->szLevel ==  $i ? 'selected' : '' ?>> LEVEL <?= $i; ?> </option>
										<?php } ?>
									</select>
							...
							<div class="col-3">
								<div class="mb-3">
									...
									<select class="form-control" name="multilvl_jabatan" id="multilvl_jabatan" data-parsley-required="true" data-parsley-errors-container=".err_multilvl_jabatan">
										<option value=""> pilih </option>
										<option value="YES" <?= $grid->szMultipleLevel == 'YES' ? 'selected' : '' ?>> Hanya 1 jabatan </option>
										<option value="NO" <?= $grid->szMultipleLevel ==  'NO' ? 'selected' : '' ?>> Boleh Banyak Jabatan</option>
									</select>
							...
							<div class="col-lg-6 col-md-6 col-12">
								<div class="mb-3">
									<label class="form-label " for="multilvl_jabatan">Status</label>
									<div class="row">
						...
						<div class="mb-3">
							...
							<textarea class="form-control" name="desc_text" id="desc_text" data-parsley-required="true" data-parsley-errors-container=".err_desc"><?= $grid->szDescription; ?></textarea>

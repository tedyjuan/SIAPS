						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="nama_mapel" name="nama_mapel" value="<?= $grid->szName; ?>"  data-parsley-required="true" data-parsley-errors-container=".err_tingkatan">

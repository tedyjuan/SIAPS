				...
				<form name="forms_add" id="forms_add" method="POST" data-parsley-validate="">
					...
					<div class="app-form">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="singkatan" name="singkatan" placeholder="Input Singkatan Contoh IPA, IPS, MTK" data-parsley-required="true" data-parsley-errors-container=".err_name">
							<span class="text-danger err_name"></span>
						</div>
						<div class="mb-3">
							<label class="form-label " for="nama_mapel">Nama Matapelajaran</label>
							<input type="text" class="form-control" id="nama_mapel" name="nama_mapel" placeholder="Input nama mapel" data-parsley-required="true" data-parsley-errors-container=".err_tingkatan">
